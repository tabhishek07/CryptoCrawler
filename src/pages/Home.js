...
const Home = () => {
  return (
    <div className="bg-gradient-to-r from-neutral-900 via-gray-800 to-rose-900 min-h-screen text-white">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-center">
        ...
        <Link to="/trending">
          <button className="bg-green-500 px-6 py-3 rounded-lg text-xl font-semibold transition-transform transform hover:scale-105">
      ...
      <section className="bg-gray-800 p-6">
        <h2 className="text-3xl font-bold text-center mb-6">Latest Updates</h2>
        <div className="flex flex-col items-center">
          <p className="text-lg mb-4">Stay informed with the latest news and updates in the cryptocurrency world.</p>
          <Link to="/news">
            <button className="bg-blue-500 px-6 py-3 rounded-lg text-xl font-semibold transition-transform transform hover:scale-105">
              Read Latest News
            </button>
          </Link>
        </div>
